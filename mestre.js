...
exports.index = (req, res) => {
    res.send('loginMestre', {jogador: req.params.jogador})
}

exports.controle = (req, res) => {
    res.send('mestre', {jogador: req.params.jogador})
}
...
exports.resetaDados = (req, res) => {
    ...
    res.send('esperaRolagens', {jogador: req.params.jogador})
}
...
exports.exibeRolgem = (req, res) => {
    ...
    res.send('resultado', {total, desafio1, desafio2, resolucao, d6, jogador: req.params.jogador})
}
...
exports.criaVotacao = (req, res) => {
    res.send('criaVotacao', {jogador: req.params.jogador})
...
exports.esperaVotacao = (req, res) => {
    ...
    res.send('esperaVotacao', {jogador: req.params.jogador})
}
